...
public class CarrefourCLI {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("🔍 Buscador de productos Carrefour");
        System.out.print("Introduce una palabra clave (ej. leche): ");
        String keyword = scanner.nextLine();

        try {
            // Paso 1: Buscar productos por nombre
            List<String> products = queryService.searchCarrefourByName(keyword);
            ...
            Set<String> categories = queryService.getCategoriesForNameSearch_Carrefour(keyword);
            ...
            List<String> filtered = queryService.searchCarrefourByNameAndCategory(keyword, selectedCategory);
